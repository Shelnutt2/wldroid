 ...
 * the config is consumed by [nu.shell.wldroid.compositor.CompositorSession].
 *
 * ## Usage
 *
 * ```kotlin
...
class CompositorConfigFactory(
     ...
     * @return A fully initialized [CompositorConfig] ready for [nu.shell.wldroid.compositor.CompositorSession]
     */
